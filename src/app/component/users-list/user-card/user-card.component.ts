        ...
        dialogRef.afterClosed()
            ...
            .subscribe((result: any) => {
                if (result) {
                    ...
                    this.snackBar.open('Данные юзера обновились!', 'Ok!', { duration: 5000 });
                } else {
                    this.snackBar.open('Отмена изменения', 'Ok!', { duration: 5000 });
                }
            });
    }
        ...
        dialogRef.afterClosed()
            ...
            .subscribe((result: boolean | undefined) => {
                if (result) {
                    ...
                    this.snackBar.open('Юзер удален...', 'Ok!', { duration: 5000 });
                } else {
                    this.snackBar.open('Отмена удаления...', 'Ok!', { duration: 5000 });
                }
            });
    };
